    ...
    public static class ApplicationDbContextExtensions
    {
        ...
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            var Users = new[]
          {
            ...
            var Games = new[]
          {
                new Game(){ Id = id, Content=
                "DASH as fast as you can!\nDODGE the oncoming trains!Help Jake, Tricky & Fresh escape from the grumpy Inspector and his dog.\n★ Grind trains with your cool crew!\n★ Colorful and vivid HD graphics!\n★ Hoverboard Surfing!\n★ Paint powered jetpack!\n★ Lightning fast swipe acrobatics!\n★ Challenge and help your friends!",Name="Subway Surfers",Price=0,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here",PublisherId=Publishers[0].Id },
                new Game(){ Id = Guid.NewGuid(), Content="The zombies are revolting ! Attack the city with a horde of zombies, change pedestrians into zombies and create the largest horde.\nEat your friends, and challenge them to a crazy race by destroying everything in your path.\nZombie Tsunami has proudly exceeded 200 million players around the world.",Name="Zombie Tsunami",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here",PublisherId=Publishers[1].Id},
                new Game(){ Id = Guid.NewGuid(), Content="With over a zillion downloads, Temple Run redefined mobile gaming. Now get more of the exhilarating running, jumping, turning and sliding you love in Temple Run 2!\nNavigate perilous cliffs, zip lines, mines and forests as you try to escape with the cursed idol. How far can you run ? !",Name="Temple Run 2",Price=50000,ReleaseDate=new DateTime(),Rating=4.3f,VideoUrl="URL Video here" ,PublisherId=Publishers[2].Id},
                ...
                new Game(){ Id = Guid.NewGuid(), Content="Start playing Candy Crush Saga today – loved by millions of players around the world.\nWith over a trillion levels played, this sweet match 3 puzzle game is one of the most popular mobile games of all time!",Name="Candy Crush Saga",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here" ,PublisherId=Publishers[4].Id},
                ...
                new Game(){ Id = Guid.NewGuid(), Content="Is it a baby? Is it a puppy? No! It’s Talking Tom! The cutest kitten, the coolest cat, and the biggest superstar in the world!\nMy Talking Tom is the best virtual pet game for children, and big kids of all ages.That’s right - even grandma and grandpa can join the fun!",Name="My Talking Tom",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here" ,PublisherId=Publishers[6].Id},
                new Game(){ Id = Guid.NewGuid(), Content="Use the unique powers of the Angry Birds to destroy the greedy pigs' defenses!\nThe survival of the Angry Birds is at stake. Dish out revenge on the greedy pigs who stole their eggs. Use the unique powers of each bird to destroy the pigs’ defenses. Angry Birds features challenging physics-based gameplay and hours of replay value. Each level requires logic, skill and force to solve.",Name="Angry Birds Classic",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here" ,PublisherId=Publishers[7].Id},
                new Game(){ Id = Guid.NewGuid(), Content="The sequel to the famous Facebook smash hit with 40 million users\nShadow Fight 2 is a nail-biting mix of RPG and classical Fighting. This game lets you equip your character with countless lethal weapons and rare armor sets, and features dozens of lifelike-animated Martial Arts techniques! Crush your enemies, humiliate demon bosses, and be the one to close the Gate of Shadows. Do you have what it takes to kick, punch, jump, and slash your way to victory? There’s only one way to find out",Name="Shadow Fight 2",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here" ,PublisherId=Publishers[8].Id},
                new Game(){ Id = Guid.NewGuid(), Content="A strange group of enemies appeared in the city and have been using innocent people as experimental tools.\nLots of people have turned into Zombie so that Hero and his friends should save the people and remove the enemies.",Name="Anger of stick 5 : zombie",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here" ,PublisherId=Publishers[4].Id},
                ...
                new Game(){ Id = Guid.NewGuid(), Content="The time to take action and strike back is now!\nWe’re calling for the best sniper in the world to take aim at evil, wherever it hides.There’s no room for remorse, so shoot to kill…",Name="Sniper Fury: Top shooting game - FPS",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here" ,PublisherId=Publishers[4].Id},
                ...
                new Game(){ Id = Guid.NewGuid(), Content="N.O.V.A. Legacy brings you the best 3D sci-fi FPS experience based on the epic first episode of N.O.V.A., which received critical acclaim -- all in a compact version of the shooter.\nKal Wardin, our hero, is a veteran N.O.V.A. marine, summoned once again to don his Mobile Armored Suit and strike against the enemies of the Colonial Administration forces.\nHelped by Yelena, his personal AI Agent, Kal must protect humanity's destiny by engaging in combat against alien invaders while uncovering the mystery behind their sudden assault.",Name="N.O.V.A. Legacy",Price=100000,ReleaseDate=new DateTime(),Rating=4.5f,VideoUrl="URL Video here" ,PublisherId=Publishers[1].Id},
